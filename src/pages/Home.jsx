    ...
    <div className="pt-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                SenseGrid provides a full-featured Industrial IoT platform
                combining embedded intelligence, flexible connectivity, and
                cloud control from real-time device management to actionable
      ...
      <section className="py-20 bg-white dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Powered By Stripe */}
          {/* insert after the motion.div that contains About SenseGrid */}
          <LogoBar />
          <AwardsBar />
        </div>
      </section>
